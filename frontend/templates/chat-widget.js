class ChatWidget {
    ...
    createWidget() {
        ...
        this.chatContainer.innerHTML = `
            ...
            ">
                ...
                <div id="chatButton" style="
                    width: 60px;
                    height: 60px;
                    background: linear-gradient(135deg, #ea66ddff 0%, #830358ff 100%);
                    border-radius: 50%;
                    cursor: pointer;
                    display: flex;
                    align-items: center;
                ...
                ">
                    ...
                    ">
                        ...
                        <div>
                            <div>Помощник ателье "Новый стиль"</div>
        ...
        setTimeout(() => {
            this.addMessage("Привет! Я помощник для ателье 'Новый стиль'. Могу ответить на вопросы о работе, расписании, заказах и многом другом. Чем могу помочь?", "bot");
        }, 1000);
    }
